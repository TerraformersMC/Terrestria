...
public class TerrestriaConfiguredFeatures {
	...
	public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
		...
		TerrestriaRegistry.register(context, SMALL_HEMLOCK_TREE, Feature.TREE, spruceOf(
				TerrestriaBlocks.HEMLOCK,
				TerrestriaBlocks.HEMLOCK_SAPLING.defaultBlockState(),
				belowTrunkProvider
		).build());

		TerrestriaRegistry.register(context, SMALL_REDWOOD_TREE, Feature.TREE, spruceOf(
				TerrestriaBlocks.REDWOOD,
				TerrestriaBlocks.REDWOOD_SAPLING.defaultBlockState(),
				belowTrunkProvider
		).build());

		TerrestriaRegistry.register(context, HEMLOCK_TREE, Feature.TREE, tallSpruceOf(
				TerrestriaBlocks.HEMLOCK,
				TerrestriaBlocks.HEMLOCK_SAPLING.defaultBlockState(),
				belowTrunkProvider,
				24, 4, 3,
		...
		TerrestriaRegistry.register(context, REDWOOD_TREE, Feature.TREE, tallSpruceOf(
				TerrestriaBlocks.REDWOOD,
				TerrestriaBlocks.REDWOOD_SAPLING.defaultBlockState(),
				belowTrunkProvider,
				24, 4, 3,
		...
		TerrestriaRegistry.register(context, MEGA_HEMLOCK_TREE, TerrestriaFeatures.QUARTERED_MEGA_TREE, giantSpruceOf(
				TerrestriaBlocks.HEMLOCK,
				TerrestriaBlocks.HEMLOCK_SAPLING.defaultBlockState(),
				belowTrunkProvider,
				32, 8, 7,
		...
		TerrestriaRegistry.register(context, MEGA_REDWOOD_TREE, TerrestriaFeatures.QUARTERED_MEGA_TREE, giantSpruceOf(
				TerrestriaBlocks.REDWOOD,
				TerrestriaBlocks.REDWOOD_SAPLING.defaultBlockState(),
				belowTrunkProvider,
				32, 8, 7,
		...
		TerrestriaRegistry.register(context, FALLEN_HEMLOCK_LOG, Feature.TREE, fallenLogOf(
				TerrestriaBlocks.HEMLOCK,
				TerrestriaBlocks.HEMLOCK_SAPLING.defaultBlockState(),
		...
		TerrestriaRegistry.register(context, FALLEN_REDWOOD_LOG, Feature.TREE, fallenLogOf(
				TerrestriaBlocks.REDWOOD,
				TerrestriaBlocks.REDWOOD_SAPLING.defaultBlockState(),
		...
		TerrestriaRegistry.register(context, JAPANESE_MAPLE_SHRUB, Feature.TREE, shrubOf(
				TerrestriaBlocks.JAPANESE_MAPLE.log.defaultBlockState(),
				TerrestriaBlocks.JAPANESE_MAPLE_SHRUB_LEAVES.defaultBlockState(),
				TerrestriaBlocks.JAPANESE_MAPLE_SHRUB_SAPLING.defaultBlockState(),
				belowTrunkProvider
		).build());

		TerrestriaRegistry.register(context, OAK_SHRUB, Feature.TREE, shrubOf(
		...
		TerrestriaRegistry.register(context, RAINBOW_EUCALYPTUS_TREE, TerrestriaFeatures.QUARTERED_MEGA_TREE, new QuarteredMegaTreeConfiguration.QuarteredMegaTreeConfigurationBuilder(
		...
		TerrestriaRegistry.register(context, SAKURA_TREE, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
				...
				new TwoLayersFeatureSize(1, 0, 1),
				belowTrunkProvider
		).decorators(ImmutableList.of(new SakuraTreeDecorator())).build());
		...
		TerrestriaRegistry.register(context, MEGA_CYPRESS_TREE, TerrestriaFeatures.QUARTERED_MEGA_TREE, new QuarteredMegaTreeConfiguration.QuarteredMegaTreeConfigurationBuilder(
				new TreeConfiguration.TreeConfigurationBuilder(
						SimpleStateProvider.simple(TerrestriaBlocks.CYPRESS.log),
		...
		TerrestriaRegistry.register(context, WILLOW_TREE, Feature.TREE, canopyOf(
				TerrestriaBlocks.WILLOW,
				TerrestriaBlocks.WILLOW_SAPLING.defaultBlockState(),
				new CanopyTree4BranchTrunkPlacer(4, 1, 1),
				ImmutableList.of(new DanglingLeavesTreeDecorator(TerrestriaBlocks.WILLOW.leaves.defaultBlockState())),
				belowTrunkProvider
		).build());
		...
		TerrestriaRegistry.register(context, OAK_DOT_SHRUB, Feature.TREE, dotShrubOf(
				Blocks.OAK_LOG.defaultBlockState(),
				Blocks.OAK_LEAVES.defaultBlockState(),
				Blocks.OAK_SAPLING.defaultBlockState(),
				belowTrunkProvider
		...
		TerrestriaRegistry.register(context, ACACIA_DOT_SHRUB, Feature.TREE, dotShrubOf(
	...
	private static TreeConfiguration.TreeConfigurationBuilder canopyOf(WoodBlocks woodBlocks, BlockState sapling, CanopyTree4BranchTrunkPlacer trunkPlacer, List<TreeDecorator> decorators, BlockStateProvider belowTrunkProvider) {
		return canopyOf(woodBlocks.log.defaultBlockState(), woodBlocks.leaves.defaultBlockState(), sapling, trunkPlacer, decorators, belowTrunkProvider);
	}

	private static TreeConfiguration.TreeConfigurationBuilder canopyOf(BlockState log, BlockState leaves, BlockState sapling, CanopyTree4BranchTrunkPlacer trunkPlacer, List<TreeDecorator> decorators, BlockStateProvider belowTrunkProvider) {
	...
	private static TreeConfiguration.TreeConfigurationBuilder fallenLogOf(WoodBlocks woodBlocks, BlockState sapling, FallenStraightTrunkPlacer trunk, BlockStateProvider belowTrunkProvider) {
		return fallenLogOf(woodBlocks.log.defaultBlockState(), woodBlocks.leaves.defaultBlockState(), sapling, trunk, belowTrunkProvider);
	}

	private static TreeConfiguration.TreeConfigurationBuilder fallenLogOf(BlockState log, BlockState leaves, BlockState sapling, FallenStraightTrunkPlacer trunk, BlockStateProvider belowTrunkProvider) {
		return new TreeConfiguration.TreeConfigurationBuilder(
				SimpleStateProvider.simple(log),
				trunk,
				SimpleStateProvider.simple(leaves),
	...
	private static TreeConfiguration.TreeConfigurationBuilder shrubOf(WoodBlocks woodBlocks, BlockState sapling, BlockStateProvider belowTrunkProvider) {
		return shrubOf(woodBlocks.log.defaultBlockState(), woodBlocks.leaves.defaultBlockState(), sapling, belowTrunkProvider);
	}

	private static TreeConfiguration.TreeConfigurationBuilder shrubOf(BlockState log, BlockState leaves, BlockState sapling, BlockStateProvider belowTrunkProvider) {
		return new TreeConfiguration.TreeConfigurationBuilder(
				SimpleStateProvider.simple(log),
	...
	private static TreeConfiguration.TreeConfigurationBuilder dotShrubOf(BlockState log, BlockState leaves, BlockState sapling, BlockStateProvider belowTrunkProvider) {
		return new TreeConfiguration.TreeConfigurationBuilder(
				SimpleStateProvider.simple(log),
	...
	private static TreeConfiguration.TreeConfigurationBuilder spruceOf(WoodBlocks woodBlocks, BlockState sapling, BlockStateProvider belowTrunkProvider) {
		return spruceOf(woodBlocks.log.defaultBlockState(), woodBlocks.leaves.defaultBlockState(), sapling, belowTrunkProvider);
	}

	private static TreeConfiguration.TreeConfigurationBuilder spruceOf(BlockState log, BlockState leaves, BlockState sapling, BlockStateProvider belowTrunkProvider) {
		return new TreeConfiguration.TreeConfigurationBuilder(
				SimpleStateProvider.simple(log),
	...
	private static TreeConfiguration.TreeConfigurationBuilder tallSpruceOf(WoodBlocks woodBlocks, BlockState sapling, BlockStateProvider belowTrunkProvider, int minHeight, int extraRandomHeight1, int extraRandomHeight2, int minLeavesRadius, int maxLeavesRadius, int minBareHeight, int maxBareHeight) {
		return tallSpruceOf(woodBlocks.log.defaultBlockState(), woodBlocks.leaves.defaultBlockState(), sapling, belowTrunkProvider, minHeight, extraRandomHeight1, extraRandomHeight2, minLeavesRadius, maxLeavesRadius, minBareHeight, maxBareHeight);
	}

	private static TreeConfiguration.TreeConfigurationBuilder tallSpruceOf(BlockState log, BlockState leaves, BlockState sapling, BlockStateProvider belowTrunkProvider, int minHeight, int extraRandomHeight1, int extraRandomHeight2, int minLeavesRadius, int maxLeavesRadius, int minBareHeight, int maxBareHeight) {
		return new TreeConfiguration.TreeConfigurationBuilder(
				SimpleStateProvider.simple(log),
	...
	private static QuarteredMegaTreeConfiguration.QuarteredMegaTreeConfigurationBuilder giantSpruceOf(WoodBlocks woodBlocks, BlockState sapling, BlockStateProvider belowTrunkProvider, int minHeight, int extraRandomHeight1, int extraRandomHeight2, int minLeavesRadius, int maxLeavesRadius, int minBareHeight, int maxBareHeight) {
		...
		return new QuarteredMegaTreeConfiguration.QuarteredMegaTreeConfigurationBuilder(
				new TreeConfiguration.TreeConfigurationBuilder(
