...
public class TerrestriaPlacedFeatures {
	...
	public static final ResourceKey<PlacedFeature> SPARSE_OAK_SHRUBS = createRegistryKey("sparse_oak_shrubs");
	public static final ResourceKey<PlacedFeature> PATCH_LUSH_FERNS = createRegistryKey("patch_lush_ferns");
	public static final ResourceKey<PlacedFeature> PATCH_VOLCANIC_ISLAND_GRASS = createRegistryKey("patch_volcanic_island_grass");
	public static final ResourceKey<PlacedFeature> PATCH_DEAD_GRASS = createRegistryKey("patch_dead_grass");
	public static final ResourceKey<PlacedFeature> PATCH_OUTBACK_BUSHLAND_GRASS = createRegistryKey("patch_outback_bushland_grass");
	public static final ResourceKey<PlacedFeature> PATCH_OASIS_VEGETATION = createRegistryKey("patch_oasis_vegetation");
	public static final ResourceKey<PlacedFeature> PATCH_LUSH_DESERT_VEGETATION = createRegistryKey("patch_lush_desert_vegetation");
	public static final ResourceKey<PlacedFeature> SPARSE_FALLEN_HEMLOCK_LOGS = createRegistryKey("sparse_fallen_hemlock_logs");
	public static final ResourceKey<PlacedFeature> SPARSE_FALLEN_REDWOOD_LOGS = createRegistryKey("sparse_fallen_redwood_logs");
	public static final ResourceKey<PlacedFeature> FALLEN_HEMLOCK_LOGS = createRegistryKey("fallen_hemlock_logs");
	public static final ResourceKey<PlacedFeature> FALLEN_REDWOOD_LOGS = createRegistryKey("fallen_redwood_logs");
	public static final ResourceKey<PlacedFeature> DENSE_FALLEN_HEMLOCK_LOGS = createRegistryKey("dense_fallen_hemlock_logs");
	public static final ResourceKey<PlacedFeature> DENSE_FALLEN_REDWOOD_LOGS = createRegistryKey("dense_fallen_redwood_logs");
	public static final ResourceKey<PlacedFeature> SPARSE_SMALL_HEMLOCK_TREES = createRegistryKey("sparse_small_hemlock_trees");
	public static final ResourceKey<PlacedFeature> SPARSE_SMALL_REDWOOD_TREES = createRegistryKey("sparse_small_redwood_trees");
	public static final ResourceKey<PlacedFeature> CALDERA_SMALL_HEMLOCK_TREES = createRegistryKey("caldera_small_hemlock_trees");
	public static final ResourceKey<PlacedFeature> CALDERA_SMALL_REDWOOD_TREES = createRegistryKey("caldera_small_redwood_trees");
	public static final ResourceKey<PlacedFeature> SMALL_HEMLOCK_TREES = createRegistryKey("small_hemlock_trees");
	public static final ResourceKey<PlacedFeature> SMALL_REDWOOD_TREES = createRegistryKey("small_redwood_trees");
	public static final ResourceKey<PlacedFeature> SPARSE_HEMLOCK_TREES = createRegistryKey("sparse_hemlock_trees");
	public static final ResourceKey<PlacedFeature> SPARSE_REDWOOD_TREES = createRegistryKey("sparse_redwood_trees");
	public static final ResourceKey<PlacedFeature> CALDERA_HEMLOCK_TREES = createRegistryKey("caldera_hemlock_trees");
	public static final ResourceKey<PlacedFeature> CALDERA_REDWOOD_TREES = createRegistryKey("caldera_redwood_trees");
	public static final ResourceKey<PlacedFeature> HEMLOCK_TREES = createRegistryKey("hemlock_trees");
	public static final ResourceKey<PlacedFeature> REDWOOD_TREES = createRegistryKey("redwood_trees");
	public static final ResourceKey<PlacedFeature> DENSE_HEMLOCK_TREES = createRegistryKey("dense_hemlock_trees");
	public static final ResourceKey<PlacedFeature> DENSE_REDWOOD_TREES = createRegistryKey("dense_redwood_trees");
	public static final ResourceKey<PlacedFeature> DENSEST_HEMLOCK_TREES = createRegistryKey("densest_hemlock_trees");
	public static final ResourceKey<PlacedFeature> DENSEST_REDWOOD_TREES = createRegistryKey("densest_redwood_trees");
	public static final ResourceKey<PlacedFeature> SPARSE_MEGA_HEMLOCK_TREES = createRegistryKey("sparse_mega_hemlock_trees");
	public static final ResourceKey<PlacedFeature> SPARSE_MEGA_REDWOOD_TREES = createRegistryKey("sparse_mega_redwood_trees");
	public static final ResourceKey<PlacedFeature> MEGA_HEMLOCK_TREES = createRegistryKey("mega_hemlock_trees");
	public static final ResourceKey<PlacedFeature> MEGA_REDWOOD_TREES = createRegistryKey("mega_redwood_trees");
	public static final ResourceKey<PlacedFeature> DENSEST_MEGA_HEMLOCK_TREES = createRegistryKey("densest_mega_hemlock_trees");
	public static final ResourceKey<PlacedFeature> DENSEST_MEGA_REDWOOD_TREES = createRegistryKey("densest_mega_redwood_trees");
	public static final ResourceKey<PlacedFeature> DENSE_FANCY_OAK_TREES = createRegistryKey("dense_fancy_oak_trees");
	public static final ResourceKey<PlacedFeature> DENSER_FANCY_OAK_TREES = createRegistryKey("denser_fancy_oak_trees");
	public static final ResourceKey<PlacedFeature> DENSEST_FANCY_OAK_TREES = createRegistryKey("densest_fancy_oak_trees");
	public static final ResourceKey<PlacedFeature> JUNGLE_PALM_TREES = createRegistryKey("jungle_palm_trees");
	public static final ResourceKey<PlacedFeature> DENSER_JUNGLE_PALM_TREES = createRegistryKey("denser_jungle_palm_trees");
	public static final ResourceKey<PlacedFeature> RARE_DUM_DUM_HEADS = createRegistryKey("rare_dum_dum_heads");
	public static final ResourceKey<PlacedFeature> DENSE_JAPANESE_MAPLE_TREES = createRegistryKey("dense_japanese_maple_trees");
	public static final ResourceKey<PlacedFeature> DENSE_DARK_JAPANESE_MAPLE_TREES = createRegistryKey("dense_dark_japanese_maple_trees");
	public static final ResourceKey<PlacedFeature> DENSE_JAPANESE_MAPLE_SHRUBS = createRegistryKey("dense_japanese_maple_shrubs");
	public static final ResourceKey<PlacedFeature> DENSER_SAKURA_TREES = createRegistryKey("denser_sakura_trees");
	public static final ResourceKey<PlacedFeature> DENSEST_CYPRESS_TREES = createRegistryKey("densest_cypress_trees");
	public static final ResourceKey<PlacedFeature> DENSER_RAINBOW_EUCALYPTUS_TREES = createRegistryKey("denser_rainbow_eucalyptus_trees");
	public static final ResourceKey<PlacedFeature> DENSE_RUBBER_TREES = createRegistryKey("dense_rubber_trees");
	public static final ResourceKey<PlacedFeature> MEGA_CYPRESS_TREES = createRegistryKey("mega_cypress_trees");
	public static final ResourceKey<PlacedFeature> SPARSE_WILLOW_TREES = createRegistryKey("sparse_willow_trees");
	public static final ResourceKey<PlacedFeature> OUTBACK_YUCCA_PALM = createRegistryKey("outback_yucca_palm");
	public static final ResourceKey<PlacedFeature> OUTBACK_BUSHLAND_TREES = createRegistryKey("outback_bushland_trees");
	public static final ResourceKey<PlacedFeature> RARE_YUCCA_PALM_TREES = createRegistryKey("yucca_palm_trees");
	public static final ResourceKey<PlacedFeature> ACACIA_DOT_SHRUBS = createRegistryKey("acacia_dot_shrubs");
	public static final ResourceKey<PlacedFeature> OAK_DOT_SHRUBS = createRegistryKey("oak_dot_shrubs");
	public static final ResourceKey<PlacedFeature> SAGUARO_CACTUSES = createRegistryKey("saguaro_cactuses");
	public static final ResourceKey<PlacedFeature> RARE_BRYCE_TREES = createRegistryKey("rare_bryce_trees");
