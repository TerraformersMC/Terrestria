	...
	public static void register() {
		TerrestriaBiomes.CYPRESS_SWAMP = TerrestriaBiomes.register("cypress_swamp", TerraformBiome.builder()
				...
				.addDefaultFeatures(LAND_CARVERS, STRUCTURES, LAKES, DUNGEONS, MINEABLES, ORES, CLAY, DEFAULT_GRASS,
						...
						DESERT_VEGETATION)
				.addTreeFeature(TerrestriaFeatures.MEGA_CYPRESS_TREE.configure(TerrestriaFeatureConfigs.CYPRESS), 2)
				...
				.addCustomFeature(GenerationStep.Feature.VEGETAL_DECORATION,
						Feature.RANDOM_PATCH
							...
							.createDecoratedFeature(Decorator.COUNT_HEIGHTMAP_DOUBLE.configure(new CountDecoratorConfig(32))))
