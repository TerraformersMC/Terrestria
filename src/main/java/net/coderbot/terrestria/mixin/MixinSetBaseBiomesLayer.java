...
public class MixinSetBaseBiomesLayer {
	...
	static {
		...
		TEMPERATE_BIOMES = new int[] { CYPRESS_FOREST_ID, SAKURA_FOREST_ID, JAPANESE_MAPLE_FOREST_ID, RAINFOREST_ID };
		SNOWY_BIOMES = new int[] { CYPRESS_FOREST_ID, SAKURA_FOREST_ID, JAPANESE_MAPLE_FOREST_ID, RAINFOREST_ID };
		DRY_BIOMES = new int[] { CYPRESS_FOREST_ID, SAKURA_FOREST_ID, JAPANESE_MAPLE_FOREST_ID, RAINFOREST_ID };
		COOL_BIOMES = new int[] { CYPRESS_FOREST_ID, SAKURA_FOREST_ID, JAPANESE_MAPLE_FOREST_ID, RAINFOREST_ID };
	}
}
