...
public class TerrestriaSurfaces {
	...
	public static <T extends SurfaceBuilder> T register(String name, T feature) {
		return Registry.register(Registry.SURFACE_BUILDER, new Identifier(Terrestria.MOD_ID, name), feature);
	}
}
