...
public class MixinSetBaseBiomesLayer {
	...
	static {
		...
		int JAPANESE_MAPLE_FOREST_ID = Registry.BIOME.getRawId(FunwoodsBiomes.JAPANESE_MAPLE_FOREST);

		// TODO: rip every other biome
		TEMPERATE_BIOMES = new int[] { CYPRESS_FOREST_ID, SAKURA_FOREST_ID, JAPANESE_MAPLE_FOREST_ID };
		SNOWY_BIOMES = new int[] { CYPRESS_FOREST_ID, SAKURA_FOREST_ID, JAPANESE_MAPLE_FOREST_ID };
		DRY_BIOMES = new int[] { CYPRESS_FOREST_ID, SAKURA_FOREST_ID, JAPANESE_MAPLE_FOREST_ID };
		COOL_BIOMES = new int[] { CYPRESS_FOREST_ID, SAKURA_FOREST_ID, JAPANESE_MAPLE_FOREST_ID };
	}
}
