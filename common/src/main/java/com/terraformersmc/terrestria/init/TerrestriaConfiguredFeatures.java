...
//		BRYCE_TREE = register("bryce_tree", TerraformTreeFeatures.SANDY_TREE, new TreeFeatureConfig.Builder(
...
//		JUNGLE_PALM_TREE = register("jungle_palm_tree", TerraformTreeFeatures.SANDY_TREE, new TreeFeatureConfig.Builder(
