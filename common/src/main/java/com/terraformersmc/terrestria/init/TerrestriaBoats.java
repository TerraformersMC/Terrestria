...
public class TerrestriaBoats {
	...
	public static void init() {
		...
		REDWOOD_BOAT_TYPE = new TerraformBoatType.Builder().item(REDWOOD_BOAT).chestItem(REDWOOD_CHEST_BOAT).planks(TerrestriaBlocks.REDWOOD.planks.asItem()).build();
		HEMLOCK_BOAT_TYPE = new TerraformBoatType.Builder().item(HEMLOCK_BOAT).chestItem(HEMLOCK_CHEST_BOAT).planks(TerrestriaBlocks.HEMLOCK.planks.asItem()).build();
		RUBBER_BOAT_TYPE = new TerraformBoatType.Builder().item(RUBBER_BOAT).chestItem(RUBBER_CHEST_BOAT).planks(TerrestriaBlocks.RUBBER.planks.asItem()).build();
		CYPRESS_BOAT_TYPE = new TerraformBoatType.Builder().item(CYPRESS_BOAT).chestItem(CYPRESS_CHEST_BOAT).planks(TerrestriaBlocks.CYPRESS.planks.asItem()).build();
		WILLOW_BOAT_TYPE = new TerraformBoatType.Builder().item(WILLOW_BOAT).chestItem(WILLOW_CHEST_BOAT).planks(TerrestriaBlocks.WILLOW.planks.asItem()).build();
		JAPANESE_MAPLE_BOAT_TYPE = new TerraformBoatType.Builder().item(JAPANESE_MAPLE_BOAT).chestItem(JAPANESE_MAPLE_CHEST_BOAT).planks(TerrestriaBlocks.JAPANESE_MAPLE.planks.asItem()).build();
		RAINBOW_EUCALYPTUS_BOAT_TYPE = new TerraformBoatType.Builder().item(RAINBOW_EUCALYPTUS_BOAT).chestItem(RAINBOW_EUCALYPTUS_CHEST_BOAT).planks(TerrestriaBlocks.RAINBOW_EUCALYPTUS.planks.asItem()).build();
		SAKURA_BOAT_TYPE = new TerraformBoatType.Builder().item(SAKURA_BOAT).chestItem(SAKURA_CHEST_BOAT).planks(TerrestriaBlocks.SAKURA.planks.asItem()).build();
		YUCCA_PALM_BOAT_TYPE = new TerraformBoatType.Builder().item(YUCCA_PALM_BOAT).chestItem(YUCCA_PALM_CHEST_BOAT).planks(TerrestriaBlocks.YUCCA_PALM.planks.asItem()).build();
